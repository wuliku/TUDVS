...
/**
 * @author admin
 * @create 2022-04-02 17:25
 * @
 */
public class TUDVSTimeCost {
    public static void main(String[] args) {
        ...
        System.out.println("System Initialization time costs");
        ...
        System.out.println("Time consumption of hash operation on G1:" + (end - begin) / 1000000.0 + "ms");
        ...
        System.out.println("Multiplication time consumption:" + (end - begin) / 1000000.0 + "ms");
        System.out.println();
        ...
        System.out.println("Time consumption of hash operation on Zp:" + (end - begin) / 1000000.0 + "ms");
        Element C = Sk_s.mulZn(h_1);
        Element V = Sk_s.mulZn(h_1.add(r));
        System.out.println();

        begin = System.nanoTime();
        Element temp = C.add(U);
        end = System.nanoTime();
        System.out.println("Addition operation time consumption:" + (end - begin) / 1000000.0 + "ms");
        System.out.println();
       ...
       /* System.out.println("Generating sign (Ticket) = (m, U, V, C): ");
        ...
        System.out.println("Time consumption of bilinear mapping:" + (end - begin) / 1000000.0 + "ms");
        System.out.println();
